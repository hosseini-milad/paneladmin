  ...
  <Router>
    {cookies.get(env.cookieName) ? (
      <Routes>
        ...
        />
        <Route
          path="/print-guaranteeStock/:orderId"
          element={<PrintGuranteeStock />}
        />
        <Route
          path="/print-guaranteeRx/:orderId"
          element={<PrintGuranteeRx />}
        />
        ...
        />
        <Route
          path="/orders/detail/previewRx/:orderId"
          element={<PreviewRx lang={lang} />}
        />
        <Route
          path="/orders/print/:orderId"
          element={<PrintArea lang={lang} />}
        />
        <Route
          path="/orders/stock/:orderId"
          element={
            <Layout>
              <StockHolder lang={lang} />
            </Layout>
          }
        />
        <Route
          ...
          element={
            <Layout>
              <StockManage lang={lang} />
            </Layout>
          }
        />
        <Route
          path="/stock/detail/:orderId"
          element={
            <Layout>
              <OrderDetailHolder lang={lang} />
            </Layout>
