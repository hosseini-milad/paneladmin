        ...
        <tr 
            ...
            <td>
              <div className="cu-avatar">
                  ...
                  window.location.href="/policys/detail/"+policy._id}>
              ...
              <td>
                <div className="order-price">
                  <p>{normalPriceCount(policy.totalPrice)}</p>
                </div>
              </td>
              <td>
                <Status status={policy.status} class={"order-status"} 
                  lang={props.lang}/>
              </td>
            <td>
              ...
              <i className={`tableIcon fas ${activeAcc?"fa-chevron-up":"fa-chevron-down"}`} 
                ...
                <i className="tableIcon fas fa-edit" onClick={()=>
                  window.location.href="/policys/detail/"+policy._id}></i>
