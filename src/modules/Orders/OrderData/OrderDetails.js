...
function OrderDetails(props){
    ...
    <div class="details-box">
        ...
        <div class="details-info">
            <div class="order-info inlineRow">
            <img src="/img/lenz01.jpg" alt="lenz"/>
            <div class="order-name">
                <p>{detail.title}</p>
                <p>{detail.sku}</p>
            </div>
            </div>
            <p class="order-num">{rxFindCount(order)}x</p>
            <p class="order-price">{normalPriceCount(detail.lenzPrice,rxFindCount(order))}</p>
        </div>
