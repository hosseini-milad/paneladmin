      ...
      <div className="row-box">
        <div className="probs-wrapper">
          <div className="input-wrapper">
            ...
            <StyleSelect
              title={tabletrans.brand[props.lang]}
              direction={props.direction}
              class={"formInput halfWidth"}
              defaultValue={content ? JSON.parse(content.brand) : ""}
              options={brand ? brand : []}
              label={"title"}
              action={(e) =>
                props.setProductChange((prevState) => ({
            ...
            />
            <StyleSelect
              title={tabletrans.category[props.lang]}
              direction={props.direction}
              class={"formInput halfWidth"}
              defaultValue={content ? JSON.parse(content.category) : ""}
            ...
            {filters ? (
              filters.map((filter, i) => (
                <StyleSelect
                  ...
                  class={"formInput halfWidth"}
                  defaultValue={
                    (defFilters && defFilters[filter.enTitle]) || ""
                  }
                  options={filter.optionsP ? filter.optionsP : []}
                  action={(e) =>
                    e &&
                    props.setChangeFilters((prevState) => ({
                      ...prevState,
                      [filter.enTitle]: e,
                    }))
                  }
            ...
            <StyleInput
              ...
              direction={props.direction}
              class={"formInput"}
              defaultValue={content ? content.price : ""}
              action={(e) =>
                props.setProductChange((prevState) => ({
                  ...prevState,
                  price: e,
            ...
            <StyleInput
              ...
              direction={props.direction}
              class={"formInput"}
              defaultValue={content ? content.price2 : ""}
              action={(e) =>
                props.setProductChange((prevState) => ({
                  ...prevState,
                  price2: e,
            ...
            <StyleInput
              ...
              direction={props.direction}
              class={"formInput"}
              defaultValue={content ? content.price4 : ""}
              action={(e) =>
                props.setProductChange((prevState) => ({
                  ...prevState,
                  price4: e,
            ...
            <StyleInput
              ...
              direction={props.direction}
              class={"formInput"}
              defaultValue={content ? content.price6 : ""}
              action={(e) =>
                props.setProductChange((prevState) => ({
                  ...prevState,
                  price6: e,
            ...
            <StyleInput
              ...
              direction={props.direction}
              class={"formInput"}
              defaultValue={content ? content.tarashPrice : ""}
              action={(e) =>
                props.setProductChange((prevState) => ({
                  ...prevState,
                  tarashPrice: e,
